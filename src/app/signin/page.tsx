          ...
          <CardContent>
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                />
                <Button type="submit" disabled={isLoading || isGoogleLoading} className="w-full bg-primary hover:bg-primary/90 text-lg py-6 rounded-xl shadow-lg shadow-primary/20">
            ...
            <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                    <span className="bg-secondary/20 px-2 text-muted-foreground">Or continue with</span>
                </div>
            </div>
             ...
             <Button
                ...
                disabled={isLoading || isGoogleLoading}
            >
                {isGoogleLoading ? 'Signing in...' : <><GoogleIcon /> <span className="ml-2">Google</span></>}
            </Button>
